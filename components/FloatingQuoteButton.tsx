  ...
  if (lang === "zh") {
    ...
    return (
      <button
        ...
        className="fixed z-50 group transition-all duration-300 md:right-6 md:top-1/2 md:-translate-y-1/2 md:bottom-auto md:translate-x-0 right-4 bottom-4 w-20 h-20 rounded-full flex items-center justify-center shadow-xl"
        aria-label="LINE 詢價"
      >
        <div className="bg-[#06C755] text-white w-full h-full rounded-full flex flex-col items-center justify-center gap-1.5">
          <LineIcon size={32} />
          <span className="text-xs font-bold leading-tight">LINE詢價</span>
        </div>
